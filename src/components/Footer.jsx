          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 bg-gray-900 border border-gray-700 rounded-lg p-3 text-xs text-gray-300 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-300 z-50 shadow-xl">
                  <p className="font-semibold text-white mb-1">Privacy Policy</p>
                  <p>We collect and process your personal data to provide job-matching services, improve our platform, and communicate with you. Your data is never sold to third parties. You can request deletion of your data at any time.</p>
              ...
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 bg-gray-900 border border-gray-700 rounded-lg p-3 text-xs text-gray-300 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-300 z-50 shadow-xl">
                  ...
                  <p>By using JobPortal, you agree to our terms governing account usage, job postings, and platform conduct. We reserve the right to suspend accounts that violate our community guidelines.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 bg-gray-900 border border-gray-700 rounded-lg p-3 text-xs text-gray-300 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-300 z-50 shadow-xl">
                  ...
                  <p>We use cookies to enhance your browsing experience, analyze site traffic, and personalize content. By using JobPortal, you agree to our use of essential, analytics, and preference cookies.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <Link
              ...
              >
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 bg-gray-900 border border-gray-700 rounded-lg p-3 text-xs text-gray-300 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-300 z-50 shadow-xl">
                  ...
                  <p>Have a question, feedback, or need support? Reach out to our team and we'll get back to you as soon as possible.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </Link>
            </div>
